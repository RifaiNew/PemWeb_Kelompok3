...
$result = mysqli_query($conn, "SELECT * FROM game where nama_game = 'valorant' ");
...
<body>
    ...
    <div class="container">
        <div class="content-left">
            <img src="https://cdn1.codashop.com/S/content/common/images/mno/VALORANT_Coda_640x241.jpg" alt="">
            <h1>Valorant</h1>
            <p>Harga sudah termasuk PPN</p><br>
            <p>PlayPoint Store telah bekerja sama dengan pemilik resmi Valorant untuk menawarkan top up Points yang mudah, aman, dan nyaman.</p><br>
            <p>Beli Valorant Points hanya dalam hitungan detik! cukup pilih jumlah Points yang Kamu inginkan, Masukan Id, selesaikan pembayaran, dan Points tersebut akan langsung masuk ke akun Valorant Kamu.</p><br>
            ...
            <div class="main-content">
                ...
                foreach ($valorant as $vlr) : ?>
                    <div id="<?= "element",$i ?>" class="custom-div">
                        <img src="https://cdn1.codashop.com/S/content/common/images/denom-image/VALORANT/VALORANT_Points.png" alt="">
                        <h4><?= $vlr["produk"] ?> Point</h4>
                        <p>Rp. <?= $vlr["harga"] ?></p>
                        <?php
                        if (isset($notlogin)) { ?>
