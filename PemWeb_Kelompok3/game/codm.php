...
$result = mysqli_query($conn, "SELECT * FROM game where nama_game = 'codm'");
...
<body>
    ...
    <div class="container">
        <div class="content-left">
            <img src="https://cdn1.codashop.com/S/content/common/images/mno/codmobile2_640x241.jpg" alt="">
            <h1>Call Of Duty Mobile</h1>
            <p>Harga sudah termasuk PPN</p><br>
            <p>PlayPoint Store telah bekerja sama dengan Activision untuk menawarkan top up CP yang mudah, aman, dan nyaman.</p><br>
            <p>Beli codm Points hanya dalam hitungan detik! cukup pilih jumlah CP yang Kamu inginkan, Masukan Id, selesaikan pembayaran, dan cp tersebut akan langsung masuk ke akun codm Kamu.</p><br>
            <p>Unduh dan mainkan codm sekarang!</p> 
            ...
            <div class="main-content">
                ...
                foreach ($codm as $vlr) : ?>
                    <div id="<?= "element",$i ?>" class="custom-div">
                        <img src="https://cdn1.codashop.com/S/content/common/images/denom-image/CODM/100x100/CallofDuty_CP.png" alt="">
                        <h4><?= $vlr["produk"] ?> Cp</h4>
                        <p>Rp. <?= $vlr["harga"] ?></p>
                        <?php
                        if (isset($notlogin)) { ?>
